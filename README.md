### <div align="center">Я Даша, начинающий андроид-разработчик 📱</div>  
...
[Учебный проект «NMedia»](https://github.com/DariaMandzyuk/AndroidProject): приложение с функциями социальной сети, реализована стена с постами, CRUD операции для постов, регистрация и авторизация, просмотр графических вложений, воспроизведение мультимедиа вложений

[Тестовое задание от компании Wildberries для студентов Нетологии](): мобильное приложение “Пора в путешествие” с двумя экранами
